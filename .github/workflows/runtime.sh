...
# Install cmake:3.26.6
  ...
  runtime-build()
  {
    ...
    common_args+=(/p:DotNetBuildFromSource=true /p:UseRidGraph=true /p:EnableNETAnalyzers=false /p:RunAnalyzersDuringBuild=false /p:_EnableILLinkRoslynAnalyzer=false)
